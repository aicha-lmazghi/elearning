...
import com.example.elearning.SpringApplicationContext;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            AccesUserDto creds = new ObjectMapper().readValue(req.getInputStream(), AccesUserDto.class);
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        UserDto userDto = userService.findUserByUserName(userName).getBody();


        res.addHeader(SecurityConstants.HEADER_STRING, SecurityConstants.TOKEN_PREFIX + token);
        res.addHeader("user_id", userDto.getIdUser());
